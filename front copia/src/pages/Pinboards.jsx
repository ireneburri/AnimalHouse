                ...
                <CardContainer className='row'>
                    ...
                    <div className="card text-center col-12 col-md-6 col-lg-4">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/pinboard:Review" className="btn btn-primary">
                                VISITA
                            </a>
                        </div>
                        <div className="card-footer text-muted"></div>
                    ...
                    <div className="card text-center col-12 col-md-6 col-lg-4">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/pinboard:Finding%20Partners" className="btn btn-primary">
                                VISITA
                            </a>
                        </div>
                        <div className="card-footer text-muted"></div>
                    ...
                    <div className="card text-center col-12 col-md-6 col-lg-4">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/pinboard:Stray%Animals" className="btn btn-primary">
                                VISITA
                            </a>
                        </div>
                        <div className="card-footer text-muted"></div>
