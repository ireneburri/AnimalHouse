        ...
        <div>
            <Container>
                ...
                <CardContainer className='row'>
                    <div className="card text-center col-12 col-md-6 col-lg-4" style={{backgroundColor: "#e6fec6"}}>
                        ...
                        <div className="card-body">
                            ...
                            <a href="/front/pinboard:None" className="btn btn-primary">
                                VISIT
                            </a>
                        </div>
                    ...
                    <div className="card text-center col-12 col-md-6 col-lg-4">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/front/pinboard:Review" className="btn btn-primary">
                                VISIT
                            </a>
                        </div>
                        <div className="card-footer text-muted"></div>
                    ...
                    <div className="card text-center col-12 col-md-6 col-lg-4">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/front/pinboard:Finding%20Partners" className="btn btn-primary">
                                VISIT
                            </a>
                        </div>
                        <div className="card-footer text-muted"></div>
                    ...
                    <div className="card text-center col-12 col-md-6 col-lg-4">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/front/pinboard:Stray%Animals" className="btn btn-primary">
                                VISIT
                            </a>
                        </div>
                        <div className="card-footer text-muted"></div>
